...
/** System Email */
$config['sender_name'] = "brufat";
$config['sender_email'] = "dalmeyda@brufat.com";
$config['super_admin_email'] = 'dalmeyda@brufat.com';
$config['receive_email'] = "dalmeyda@brufat.com";
$config['fcm_api_key']  = "AIzaSyCSESFDGKWCybdxdSyhGQBLceDURqGkiLc";

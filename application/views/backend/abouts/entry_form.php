    ...
    <div class="col-12"  style="padding: 30px 20px 20px 20px;">
        ...
        <!-- /.card-header -->
        	...
        	<div class="card-body">
	            ...
	            <hr>
	            <!-- Start icon -->
	            <legend class="ml-3"><?php echo get_msg('about_backend_icon')?></legend>
	            <div class="col-md-6">
	            	 <?php if ( !isset( $about )): ?>
						...
						<div class="form-group">
							...
							<label>
								<?php echo get_msg('about_nav_icon')?>
								<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('cat_photo_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
								</a>
							</label>
						...
						<?php
							$conds = array( 'img_type' => 'nav', 'img_parent_id' => $about->id );
							$images = $this->Image->get_all_by( $conds )->result();
						?>
	            ...
	            <div class="col-md-6">
	            	 <?php if ( !isset( $about )): ?>
						...
						<div class="form-group">
							...
							<label>
								<?php echo get_msg('about_fav_icon')?>
								<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('cat_photo_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
								</a>
							</label>
						...
						<?php
							$conds = array( 'img_type' => 'fav', 'img_parent_id' => $about->id );
							$images = $this->Image->get_all_by( $conds )->result();
						?>
